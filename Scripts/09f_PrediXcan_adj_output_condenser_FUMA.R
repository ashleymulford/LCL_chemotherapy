...
fwrite(YRI_pred_sign6, "/home/ashley/LCL_chemotherapy/YRI/YRI_assoc_gemma_output_combined/YRI_pred_adj_condensed_fdr6", na = "NA", quote = F, sep = "\t", col.names = T) 
fwrite(YRI_pred_sign3, "/home/ashley/LCL_chemotherapy/YRI/YRI_assoc_gemma_output_combined/YRI_pred_adj_condensed_fdr3", na = "NA", quote = F, sep = "\t", col.names = T) 
fwrite(YRI_pred_sign2, "/home/ashley/LCL_chemotherapy/YRI/YRI_assoc_gemma_output_combined/YRI_pred_adj_condensed_fdr2", na = "NA", quote = F, sep = "\t", col.names = T) 
fwrite(YRI_pred_sign075, "/home/ashley/LCL_chemotherapy/YRI/YRI_assoc_gemma_output_combined/YRI_pred_adj_condensed_fdr075", na = "NA", quote = F, sep = "\t", col.names = T) 
