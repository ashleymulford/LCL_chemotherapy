...
for(drug in drug_list){
  YRI_pred <- fread("/home/ashley/LCL_chemotherapy/YRI/YRI_assoc_gemma_output_combined/YRI_predixcan_adjusted_" %&% drug %&% ".txt")
  YRI_pred<-add_column(YRI_pred, drug = drug, .before = "tissue")
  YRI_pred_significant<-subset(YRI_pred, pvalues_adjusted_BH <= .6)
...
YRI_pred_sign2 <- subset(YRI_pred_sign6, pvalues_adjusted_BH <= .2)
YRI_pred_sign075 <- subset(YRI_pred_sign6, pvalues_adjusted_BH <= .075)

#Output data frames into directory
fwrite(YRI_pred_sign6, "/home/ashley/LCL_chemotherapy/YRI/YRI_assoc_gemma_output_combined/YRI_pred_adj_condensed_BH6", na = "NA", quote = F, sep = "\t", col.names = T) 
fwrite(YRI_pred_sign3, "/home/ashley/LCL_chemotherapy/YRI/YRI_assoc_gemma_output_combined/YRI_pred_adj_condensed_BH3", na = "NA", quote = F, sep = "\t", col.names = T) 
fwrite(YRI_pred_sign2, "/home/ashley/LCL_chemotherapy/YRI/YRI_assoc_gemma_output_combined/YRI_pred_adj_condensed_BH2", na = "NA", quote = F, sep = "\t", col.names = T) 
fwrite(YRI_pred_sign075, "/home/ashley/LCL_chemotherapy/YRI/YRI_assoc_gemma_output_combined/YRI_pred_adj_condensed_BH075", na = "NA", quote = F, sep = "\t", col.names = T) 
