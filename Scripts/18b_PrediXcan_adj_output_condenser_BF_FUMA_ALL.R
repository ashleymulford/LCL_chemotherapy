...
fwrite(gn_list_fuma, "/home/ashley/LCL_chemotherapy/ALL/ALL_assoc_gemma_output_combined/ALL_predixcan_genes_bonferroni_FUMA", na = "NA", quote = F, sep = "\t", col.names = T)
